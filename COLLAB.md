...
- **Working on:** **Phase 3, Tier 2 — templates — DONE (2026-06-13).** Tier 2a (per-type item templates, ADR-045, slice 34) + Tier 2b (workflow/wiki structure generator + board-by-property, ADR-046, slice 35). (Tier 1 — Build surface + type/property builder — ADR-044/slice 33; Phase M — ADR-040/041/043.)
- **Next:** **Phase 3, Tier 3 — the Claude layer:** the MCP server (search/read/create/update items over a personal API token), then scheduled Claude tasks + the selective Notion migration.
...
- **Last updated:** 2026-06-13 (Tier 2 complete — templates: item + workflow/wiki)
