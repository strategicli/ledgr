...
//
// The page file stays at src/app/items/[id]/explore/page.tsx (Next.js needs
// it there) and renders this through src/lib/module-panels.tsx, because
// src/app/items/** is core and may not import a module (ADR-272 step 4).
...
import { exploreNeighborhood } from "@/modules/relatedness/lib/explore";
import ExploreRow from "@/modules/relatedness/components/ExploreRow";

const TRAIL_MAX = 6;

export default async function ExploreView({
  itemId: id,
  search,
}: {
  itemId: string;
