...
**Status:** parked (Brandon, 2026-06-19). Not intent, not a decision. **Explicitly post-1.0**, not a v1.0 item. A collapsible "you might want to link these" area at the bottom of every item, ranked by a relatedness score that a background job computes slowly over time, with one click to make any suggestion a real association.
