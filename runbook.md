...
| Weekly health check (read the `/health` canaries, push Brandon on failure; ADR-048) | weekly Mon 13:00 UTC (`.github/workflows/health-check.yml`) | `GET /api/machine/health-check` | same `Bearer $LEDGR_CRON_TOKEN` path |
